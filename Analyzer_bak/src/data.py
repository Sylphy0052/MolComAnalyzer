    ...
    def parseConfig(self):
        ...
        with open(self.config_file_name, 'r') as f:
            for line in f:
                ...
                elif key in ["probDRail", "stepLengthX", "stepLengthY", "stepLengthZ", "packetStepLengthX", "packetStepLengthY", "packetStepLengthZ", "packetDiameter", "pakcetStepLengthX", "pakcetStepLengthY", "pakcetStepLengthZ", "drobDRail"]:
...
class InputData:
    def __init__(self, data):
        self.is_ptime = True
        self.is_coll = data.config["useCollisions"]
